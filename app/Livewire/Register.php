    ...
    protected function getFormSchema(): array
    {
        return [
            Wizard::make([
                ...
                ->schema([
                    TextInput::make('designation')->label('Designation')->required()->maxLength(50)->autofocus(),
                    TextInput::make('website')->label('Website')->prefix('https://')->maxLength(50),
                    TextInput::make('address')->label('Address')->maxLength(100),
